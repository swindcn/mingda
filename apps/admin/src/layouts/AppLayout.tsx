...
export const allMenuItems: AppMenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        key: '/dashboard/production/molding-tasks',
        icon: <Boxes size={18} />,
        label: '造型下芯',
        permission: 'production.molding.view',
      },
      {
        key: '/dashboard/production/pouring-tasks',
        icon: <Droplets size={18} />,
        label: '合型浇注',
        permission: 'production.pouring.view',
      },
      {
        key: '/dashboard/production/shake-clean-tasks',
        icon: <Hammer size={18} />,
        label: '落砂清理',
        permission: 'production.shake_clean.view',
      },
      {
        key: '/dashboard/production/inspection-tasks',
        icon: <ShieldCheck size={18} />,
        label: '成品终检',
        permission: 'production.inspection.view',
      },
      {
